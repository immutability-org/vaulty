...
import (
	...
	"github.com/immutability-org/vaulty/application"
	"github.com/immutability-org/vaulty/models"
	"github.com/immutability-org/vaulty/libunix"
)
...
func newConfig() (*viper.Viper, error) {
	...
	c := viper.New()
	c.SetDefault("dsn", fmt.Sprintf("postgres://%v@localhost:5432/vaulty?sslmode=disable", u))
	c.SetDefault("cookie_secret", "dyOnpM-Jg-nCCp4k")
